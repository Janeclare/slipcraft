...
const B = "-",
    ae = e => {
        ...
        return {
            getClassGroupId: i => {
                const s = i.split(B);
                return s[0] === "" && s.length !== 1 && s.shift(), D(s, r) || ie(i)
            },
    ...
    ce = e => {
        ...
        return pe(Object.entries(e.classGroups), t).forEach(([n, i]) => {
            $(i, o, n, r)
        }), o
    },
    $ = (e, r, t, o) => {
    ...
    pe = (e, r) => r ? e.map(([t, o]) => {
        const l = o.map(n => typeof n == "string" ? r + n : typeof n == "object" ? Object.fromEntries(Object.entries(n).map(([i, s]) => [r + i, s])) : n);
        return [t, l]
    }) : e,
    ue = e => {
        if (e < 1) return {
        ...
        return {
            get(n) {
                ...
                if ((i = o.get(n)) !== void 0) return l(n, i), i
            },
            set(n, i) {
                t.has(n) ? t.set(n, i) : l(n, i)
            }
        }
    },
    ee = "!",
    be = e => {
        ...
        } = e, o = r.length === 1, l = r[0], n = r.length, i = s => {
            const u = [];
            let g = 0,
                m = 0,
                y;
...
const Be = se(Ve);
export {
    Be as R, le as a, $e as c, Ve as r
};