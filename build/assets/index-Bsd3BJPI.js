...
var G = {},
    $ = function() {
        return $ = Object.assign || function(s) {
            for (var i, u = 1, l = arguments.length; u < l; u++)
                for (var n in i = arguments[u]) Object.prototype.hasOwnProperty.call(i, n) && (s[n] = i[n]);
            return s
    ...
    at = (function() {
        function s(i, u, l) {
            var n = this;
            this.endVal = u, this.options = l, this.version = "2.8.0", this.defaults = {
                startVal: 0,
                decimalPlaces: 0,
                duration: 2,
                useEasing: !0,
                ...
                scrollSpyDelay: 200,
                scrollSpyOnce: !1
            }, this.finalEndVal = null, this.useEasing = !0, this.countDown = !1, this.error = "", this.startVal = 0, this.paused = !0, this.once = !1, this.count = function(c) {
                n.startTime || (n.startTime = c);
                var g = c - n.startTime;
                n.remaining = n.duration - g, n.useEasing ? n.countDown ? n.frameVal = n.startVal - n.easingFn(g, 0, n.startVal - n.endVal, n.duration) : n.frameVal = n.easingFn(g, n.startVal, n.endVal - n.startVal, n.duration) : n.frameVal = n.startVal + (n.endVal - n.startVal) * (g / n.duration);
                var h = n.countDown ? n.frameVal < n.endVal : n.frameVal > n.endVal;
                n.frameVal = h ? n.endVal : n.frameVal, n.frameVal = Number(n.frameVal.toFixed(n.options.decimalPlaces)), n.printValue(n.frameVal), g < n.duration ? n.rAF = requestAnimationFrame(n.count) : n.finalEndVal !== null ? n.update(n.finalEndVal) : n.options.onCompleteCallback && n.options.onCompleteCallback()
            }, this.formatNumber = function(c) {
                var g, h, V, C, L = c < 0 ? "-" : "";
                g = Math.abs(c).toFixed(n.options.decimalPlaces);
                var _ = (g += "").split(".");
                if (h = _[0], V = _.length > 1 ? n.options.decimal + _[1] : "", n.options.useGrouping) {
                    C = "";
                    for (var Y = 3, I = 0, P = 0, k = h.length; P < k; ++P) n.options.useIndianSeparators && P === 4 && (Y = 2, I = 1), P !== 0 && I % Y == 0 && (C = n.options.separator + C), I++, C = h[k - P - 1] + C;
                    h = C
                }
                return n.options.numerals && n.options.numerals.length && (h = h.replace(/[0-9]/g, (function(N) {
                    return n.options.numerals[+N]
                })), V = V.replace(/[0-9]/g, (function(N) {
                    return n.options.numerals[+N]
                }))), L + n.options.prefix + h + V + n.options.suffix
            }, this.easeOutExpo = function(c, g, h, V) {
                return h * (1 - Math.pow(2, -10 * c / V)) * 1024 / 1023 + g
        ...
        return s.prototype.handleScroll = function(i) {
            if (i && window && !i.once) {
                var u = window.innerHeight + window.scrollY,
                    l = i.el.getBoundingClientRect(),
                    n = l.top + window.pageYOffset,
                    c = l.top + l.height + window.pageYOffset;
                c < u && c > window.scrollY && i.paused ? (i.paused = !1, setTimeout((function() {
                    return i.start()
                }), i.options.scrollSpyDelay), i.options.scrollSpyOnce && (i.once = !0)) : (window.scrollY > c || n > u) && !i.paused && i.reset()
            }
...
function ot() {
    ...
    function u(r, t) {
        ...
        if (e != null) {
            var a, o, f, w, y = [],
                ...
                p = !1;
            try {
                if (f = (e = e.call(r)).next, t !== 0)
                    for (; !(d = (a = f.call(e)).done) && (y.push(a.value), y.length !== t); d = !0);
            } catch (m) {
                p = !0, o = m
            } finally {
                try {
                    if (!d && e.return != null && (w = e.return(), Object(w) !== w)) return
                } finally {
                    if (p) throw o
                }
            }
    ...
    function n(r) {
        for (var t = 1; t < arguments.length; t++) {
            ...
            t % 2 ? l(Object(e), !0).forEach(function(a) {
                h(r, a, e[a])
            }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(r, Object.getOwnPropertyDescriptors(e)) : l(Object(e)).forEach(function(a) {
    ...
    function h(r, t, e) {
        return t = g(t), t in r ? Object.defineProperty(r, t, {
            value: e,
            enumerable: !0,
            configurable: !0,
            writable: !0
    ...
    function C(r, t) {
        ...
        var e = {},
            a = Object.keys(r),
            o, f;
        for (f = 0; f < a.length; f++) o = a[f], !(t.indexOf(o) >= 0) && (e[o] = r[o]);
        return e
    }
    ...
    function L(r, t) {
        ...
        if (Object.getOwnPropertySymbols) {
            ...
            for (o = 0; o < f.length; o++) a = f[o], !(t.indexOf(a) >= 0) && Object.prototype.propertyIsEnumerable.call(r, a) && (e[a] = r[a])
        }
        return e
    }
    ...
    function I(r, t) {
        if (r) {
            if (typeof r == "string") return P(r, t);
            var e = Object.prototype.toString.call(r).slice(8, -1);
            if (e === "Object" && r.constructor && (e = r.constructor.name), e === "Map" || e === "Set") return Array.from(r);
            if (e === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(e)) return P(r, t)
        }
    }
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)
    ...
    var J = function(t, e) {
        ...
        W = function(t) {
            var e = Object.fromEntries(Object.entries(t).filter(function(S) {
                    var q = _(S, 2),
                        B = q[1];
                    return B !== void 0
                })),
                ...
                E = s.useRef(!1),
                D = v(function() {
                    return J(typeof o == "string" ? o : o.current, U)
                }),
                b = v(function(S) {
                    var q = x.current;
                    if (q && !S) return q;
                    var B = D();
                    return x.current = B, B
                }),
                T = v(function() {
                    var S = function() {
                    ...
                    y && y > 0 ? O.current = setTimeout(S, y * 1e3) : S(), p ?.({
                        pauseResume: R,
                        reset: F,
                        update: M
                    })
        ...
        Z = ["className", "redraw", "containerProps", "children", "style"],
        tt = function(t) {
            var e = t.className,
                a = t.redraw,
                o = t.containerProps,
                ...
                D = v(function(R) {
                    t.preserveValue || A(), U(R)
                }),
                b = v(function() {
                    if (typeof t.children == "function" && !(d.current instanceof Element)) {
