...
var U = "ScrollArea",
    ...
    G = s.forwardRef((e, o) => {
        const {
            ...
            ...c
        } = e, [a, i] = s.useState(null), [f, d] = s.useState(null), [b, u] = s.useState(null), [S, w] = s.useState(null), [A, Y] = s.useState(null), [x, _] = s.useState(0), [M, D] = s.useState(0), [j, y] = s.useState(!1), [N, W] = s.useState(!1), m = T(o, R => i(R)), v = de(t);
        return h.jsx(he, {
            scope: r,
            type: n,
            dir: v,
...
var J = "ScrollAreaViewport",
    K = s.forwardRef((e, o) => {
        const {
            ...
            nonce: t,
            ...l
        } = e, c = p(J, r), a = s.useRef(null), i = T(o, a, c.onViewportChange);
...
var g = "ScrollAreaScrollbar",
    V = s.forwardRef((e, o) => {
        const {
            forceMount: r,
            ...n
        } = e, t = p(g, e.__scopeScrollArea), {
            onScrollbarXEnabledChange: l,
            onScrollbarYEnabledChange: c
        } = t, a = e.orientation === "horizontal";
        return s.useEffect(() => (a ? l(!0) : c(!0), () => {
            a ? l(!1) : c(!1)
        }), [a, l, c]), t.type === "hover" ? h.jsx(be, { ...n,
            ref: o,
            forceMount: r
        }) : t.type === "scroll" ? h.jsx(Se, { ...n,
            ref: o,
            forceMount: r
        }) : t.type === "auto" ? h.jsx(Q, { ...n,
            ref: o,
            forceMount: r
        }) : t.type === "always" ? h.jsx(B, { ...n,
            ref: o
        }) : null
    });
V.displayName = g;
var be = s.forwardRef((e, o) => {
        const {
            forceMount: r,
            ...n
        } = e, t = p(g, e.__scopeScrollArea), [l, c] = s.useState(!1);
        return s.useEffect(() => {
        ...
        }, [t.scrollArea, t.scrollHideDelay]), h.jsx(O, {
            present: r || l,
            children: h.jsx(Q, {
    ...
    Se = s.forwardRef((e, o) => {
        const {
            forceMount: r,
            ...n
        } = e, t = p(g, e.__scopeScrollArea), l = e.orientation === "horizontal", c = X(() => i("SCROLL_END"), 100), [a, i] = fe("hidden", {
            hidden: {
                SCROLL: "scrolling"
            },
            scrolling: {
    ...
    Q = s.forwardRef((e, o) => {
        const r = p(g, e.__scopeScrollArea),
            {
                forceMount: n,
                ...t
            } = e,
        ...
        return E(r.viewport, i), E(r.content, i), h.jsx(O, {
            present: n || l,
            children: h.jsx(B, {
                "data-state": l ? "visible" : "hidden",
                ...t,
    ...
    B = s.forwardRef((e, o) => {
        const {
            ...
            ...n
        } = e, t = p(g, e.__scopeScrollArea), l = s.useRef(null), c = s.useRef(0), [a, i] = s.useState({
            content: 0,
            viewport: 0,
            scrollbar: {
                size: 0,
        ...
        function b(u, S) {
            return xe(u, c.current, a, S)
        }
        return r === "horizontal" ? h.jsx(me, { ...d,
            ref: o,
        ...
        }) : r === "vertical" ? h.jsx(pe, { ...d,
            ref: o,
            onThumbPositionChange: () => {
                if (t.viewport && l.current) {
                    const u = t.viewport.scrollTop,
                        S = F(u, a);
                    l.current.style.transform = `translate3d(0, ${S}px, 0)`
                }
            },
            onWheelScroll: u => {
    ...
    pe = s.forwardRef((e, o) => {
        const {
            ...
            onSizesChange: n,
            ...t
        } = e, l = p(g, e.__scopeScrollArea), [c, a] = s.useState(), i = s.useRef(null), f = T(o, i, l.onScrollbarYChange);
        return s.useEffect(() => {
            i.current && a(getComputedStyle(i.current))
        }, [i]), h.jsx(ee, {
    ...
    ee = s.forwardRef((e, o) => {
        const {
            ...
            onResize: b,
            ...u
        } = e, S = p(g, r), [w, A] = s.useState(null), Y = T(o, m => A(m)), x = s.useRef(null), _ = s.useRef(""), M = S.viewport, D = n.content - n.viewport, j = P(d), y = P(i), N = X(b, 10);

        function W(m) {
            if (x.current) {
                const v = m.clientX - x.current.left,
                    R = m.clientY - x.current.top;
                f({
                    x: v,
                    y: R
                })
        ...
        return s.useEffect(() => {
        ...
        }, [M, w, D, j]), s.useEffect(y, [n, y]), E(w, N), E(S.content, N), h.jsx(ve, {
            scope: r,
            scrollbar: w,
            hasThumb: t,
            onThumbChange: P(l),
            ...
            children: h.jsx(L.div, { ...u,
                ...
                onPointerDown: C(e.onPointerDown, m => {
                    m.button === 0 && (m.target.setPointerCapture(m.pointerId), x.current = w.getBoundingClientRect(), _.current = document.body.style.webkitUserSelect, document.body.style.webkitUserSelect = "none", S.viewport && (S.viewport.style.scrollBehavior = "auto"), W(m))
                }),
                onPointerMove: C(e.onPointerMove, W),
                onPointerUp: C(e.onPointerUp, m => {
                    const v = m.target;
                    v.hasPointerCapture(m.pointerId) && v.releasePointerCapture(m.pointerId), document.body.style.webkitUserSelect = _.current, S.viewport && (S.viewport.style.scrollBehavior = ""), x.current = null
                })
            })
        })
    }),
    ...
    we = s.forwardRef((e, o) => {
        ...
        } = c, i = T(o, b => c.onThumbChange(b)), f = s.useRef(void 0), d = X(() => {
...
var k = "ScrollAreaCorner",
    oe = s.forwardRef((e, o) => {
        const r = p(k, e.__scopeScrollArea),
            n = !!(r.scrollbarX && r.scrollbarY);
        return r.type !== "scroll" && n ? h.jsx(ge, { ...e,
            ref: o
        }) : null
    });
oe.displayName = k;
var ge = s.forwardRef((e, o) => {
    const {
        __scopeScrollArea: r,
        ...n
    } = e, t = p(k, r), [l, c] = s.useState(0), [a, i] = s.useState(0), f = !!(l && a);
...
const ce = s.forwardRef(({
    ...
    ref: n,
    orientation: o,
    className: $("flex touch-none select-none transition-colors", o === "vertical" && "h-full w-2.5 border-l border-l-transparent p-[1px]", o === "horizontal" && "h-2.5 flex-col border-t border-t-transparent p-[1px]", e),
    ...r,
    children: h.jsx(re, {
