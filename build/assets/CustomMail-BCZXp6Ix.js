...
const ee = ({
    ...
    const {
        ...
        if (x(), a.show_action_button && !S.isURL(a.button_link.trim())) {
            p("button_link", "Button link must be a valid URL. e.g https://example.com"), r.error("Button link must be a valid URL. e.g https://example.com"), n(!1);
            return
        }
        m(route("coinbase.send_email_custom"), {
            onSuccess: () => {
                r.success("Flash Mail Sent Successfully"), n(!1)
            },
            onError: t => {
                v(t), n(!1)
            }
    ...
    return e.jsxs(j, {
        children: [e.jsx(_, {
            title: "Coinbase Custom Flash Mail"
        }), e.jsx("main", {
            ...
            children: e.jsxs("div", {
                ...
                children: [e.jsxs("div", {
                    ...
                    children: [e.jsx(g, {}), e.jsx("h1", {
                        ...
                        children: "Coinbase Custom Flash Email"
                    }), e.jsx("h1", {
                        className: "font-bold text-lg opacity-0 hidden sm:block",
                        children: "."
                    })]
                }), e.jsx(y, {
                    onClick: () => b.get(route("services.coinbase")),
                    iconSrc: k
                }), e.jsx("section", {
                    ...
                    children: e.jsxs("div", {
                        ...
                        children: [e.jsxs("div", {
                            ...
                            children: [e.jsx(l, {
                                ...
                                id: "company_name",
                                onChange: t => s("company_name", t.target.value),
                                value: a.company_name,
                                placeholder: "Enter the company name e.g Binance"
                            }), e.jsx("p", {
                            ...
                            children: [e.jsx(l, {
                                ...
                                className: "w-full max-w-[500px]",
                                id: "recipient_email",
                                onChange: t => s("recipient_email", t.target.value),
                            ...
                            children: [e.jsx(l, {
                                ...
                                className: "w-full max-w-[500px]",
                                id: "mail_subject",
                                onChange: t => s("mail_subject", t.target.value),
                            ...
                            children: [e.jsx(l, {
                                ...
                                id: "mail_body",
                                onChange: t => s("mail_body", t.target.value),
                                value: a.mail_body,
                            ...
                            children: [e.jsx(E, {
                                ...
                                onCheckedChange: t => s("show_action_button", t),
                            ...
                            children: [e.jsx(l, {
                                ...
                                className: "w-full max-w-[500px]",
                                id: "button_text",
                                onChange: t => s("button_text", t.target.value),
                                value: a.button_text,
                            ...
                            children: [e.jsx(l, {
                                ...
                                className: "w-full max-w-[500px]",
                                id: "button_link",
                                onChange: t => s("button_link", t.target.value),
                                value: a.button_link,
